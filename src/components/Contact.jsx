  ...
  return (
    <section id="contact" className="py-24 px-6 bg-slate-50">
      <div className="max-w-6xl mx-auto">
        <p className="text-indigo-600 text-xs font-bold tracking-widest uppercase mb-3">Say Hello</p>
        ...
        <div className="grid sm:grid-cols-3 gap-4 max-w-3xl">
          <a href="mailto:aliibraheem8886@gmail.com"
            ...
            <p className="text-slate-900 font-semibold text-sm group-hover:text-indigo-600 transition-colors">aliibraheem8886@gmail.com</p>
          </a>
          ...
          <a href="https://linkedin.com/in/ali-ibraheem-b1260222a" target="_blank" rel="noreferrer"
            ...
            <p className="text-slate-900 font-semibold text-sm group-hover:text-indigo-600 transition-colors">ali-ibraheem</p>
          </a>
          ...
          <a href="https://github.com/ibraheem88" target="_blank" rel="noreferrer"
            ...
            <p className="text-slate-900 font-semibold text-sm group-hover:text-indigo-600 transition-colors">ibraheem88</p>
          </a>
        </div>
      </div>
    </section>
